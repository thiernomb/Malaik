...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_5f0ad8d8e57109321a4608705afae5170b2283daadcfb52b47fc6cc31a8a763c');
    ...
    {
        return $this->services['prestashop.adapter.memcache_server.manager'] = new \PrestaShop\PrestaShop\Adapter\Cache\MemcacheServerManager($this->get('doctrine.dbal.default_connection'), 'malaik_');
    }
    ...
    {
        return $this->services['prestashop.core.api.category.repository'] = new \PrestaShopBundle\Entity\Repository\CategoryRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'malaik_');
    }
    ...
    {
        return $this->services['prestashop.core.api.feature_attribute.repository'] = new \PrestaShopBundle\Entity\Repository\FeatureAttributeRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'malaik_');
    }
    ...
    {
        return $this->services['prestashop.core.api.manufacturer.repository'] = new \PrestaShopBundle\Entity\Repository\ManufacturerRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'malaik_');
    }
    ...
    {
        return $this->services['prestashop.core.api.stockmovement.repository'] = new \PrestaShopBundle\Entity\Repository\StockMovementRepository($this, $this->get('doctrine.dbal.default_connection'), $this->get('doctrine.orm.default_entity_manager'), $this->get('prestashop.adapter.legacy.context'), $this->get('prestashop.adapter.image_manager'), 'malaik_');
    }
    ...
    {
        return $this->services['prestashop.core.api.supplier.repository'] = new \PrestaShopBundle\Entity\Repository\SupplierRepository($this->get('doctrine.dbal.default_connection'), $this->get('prestashop.adapter.legacy.context'), 'malaik_');
    }
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('malaik_');
    }
    ...
    {
        return $this->services['prestashop.module_kernel.repository'] = new \PrestaShopBundle\Kernel\ModuleRepository($this->get('doctrine.dbal.default_connection'), 'malaik_');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('BF4jujjoJzR74qtBy8IyPOn7byLR2wnupc0Awvhh3RWgdAfX0QWkIpt8');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5ad25a4d0b3fb1.33717359')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => '',
            'database_name' => 'malaik_db',
            'database_user' => 'root',
            'database_password' => '',
            'database_prefix' => 'malaik_',
            'database_engine' => 'InnoDB',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'BF4jujjoJzR74qtBy8IyPOn7byLR2wnupc0Awvhh3RWgdAfX0QWkIpt8',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-04-14',
            'locale' => 'fr-FR',
            'cookie_key' => '0ZZMQJF66ZMIsprbTuv7uEGDNajiifgE8umXEWI3CRd85D1JjRWtnb9G',
            'cookie_iv' => 'tEbEKxY8',
            'new_cookie_key' => 'def000002f0ccd8784a2164eb0ffe7da3a75c7b3acb34f038af430f01e71f2bc8920e3b3e298aefa45a803338b0608d75f65ce812603064ac88833507ae386118428168b',
            ...
            'kernel.secret' => 'BF4jujjoJzR74qtBy8IyPOn7byLR2wnupc0Awvhh3RWgdAfX0QWkIpt8',
