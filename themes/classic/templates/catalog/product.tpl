    ...
    * @copyright 2007-2017 PrestaShop SA * @license https://opensource.org/licenses/AFL-3.0 Academic Free License 3.0 (AFL-3.0) * International Registered Trademark & Property of PrestaShop SA *} {extends file=$layout} {block name='head_seo' prepend}
    ...
    <section id="main" itemscope itemtype="https://schema.org/Product">
        ...
        <div class="row">
            ...
            {* TMBD
                j'ai ajouter la propriété background-color pour avoir une encapsulation blache à droite dela page
                lorsque nous sommes au niveau de la page de detail d'un produit 
                sinon aucune encapsulation ne sera faite et la couleur restera grise
                j'ai aussi agmenté le padding pour une bonne mise en forme
                pour ce faire j'ai defini la classe information_product_details pour lequel 
                j'ai defini le style dans en bas du fichier theme.css
            *}
            <div class="col-md-6 information_product_details">
                ...
                <div class="product-information">
                    ...
                    <div class="product-actions">
                        ...
                        <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                            ...
                            <input type="hidden" name="id_customization" value="{$product.id_customization}" id="product_customization_id"> {block name='product_variants'} {include file='catalog/_partials/product-variants.tpl'} {/block} {block name='product_pack'}
                            {if $packItems}
                            ...
                            {/if} {/block} {block name='product_discounts'} {include file='catalog/_partials/product-discounts.tpl'} {/block} {block name='product_add_to_cart'} {include file='catalog/_partials/product-add-to-cart.tpl'} {/block} {block name='product_additional_info'}
                            {include file='catalog/_partials/product-additional-info.tpl'} {/block} {block name='product_refresh'}
